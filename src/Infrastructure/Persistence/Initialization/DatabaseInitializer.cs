...
internal class DatabaseInitializer : IDatabaseInitializer
{
    ...
    public async Task InitializeDatabasesAsync(CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("For documentations and guides, visit https://www.tandan.net");
        _logger.LogInformation("To Sponsor this project, visit https://opencollective.com/tandan");
    }
